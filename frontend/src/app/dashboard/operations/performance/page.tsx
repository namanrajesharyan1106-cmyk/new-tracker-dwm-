  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col items-center justify-center min-h-[400px] bg-neutral-900/50 backdrop-blur-md border border-white/10 rounded-2xl p-8 text-center">
        <TrendingUp className="w-16 h-16 text-emerald-500/50 mb-4" />
        <h3 className="text-xl font-semibold mb-2">Team Performance</h3>
        <p className="text-neutral-400">KPIs, completion rates, and delay analysis will be accessible here.</p>
      </div>
    </div>
  );
}
